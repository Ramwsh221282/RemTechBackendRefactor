...
export const DefaultLocationQuery: () => GetLocationsQueryParameters = (): GetLocationsQueryParameters => {
    return {
        BrandId: undefined,
        BrandName: undefined,
...
export const LocationsQueryWithOrderByName: (
    use: boolean | null | undefined,
    query: GetLocationsQueryParameters,
) => GetLocationsQueryParameters = (
    use: boolean | null | undefined,
    query: GetLocationsQueryParameters,
): GetLocationsQueryParameters => {
    return { ...query, OrderByName: use };
};
