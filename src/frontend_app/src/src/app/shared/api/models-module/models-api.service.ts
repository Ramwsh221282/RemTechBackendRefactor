...
export class ModelsApiService {
  ...
  private fetchingModels$: Observable<TypedEnvelope<ModelResponse>> | undefined;

  public fetchModels(): Observable<TypedEnvelope<ModelResponse>> {
  ...
  ): Observable<TypedEnvelope<ModelResponse>> {
    if (this.fetchingModels$) return this.fetchingModels$;
    let params: HttpParams = new HttpParams();
    if (id) params = params.append('modelId', id);
    if (name) params = params.append('modelName', name);
