...
/// <summary>
/// Производитель сообщений RabbitMQ.
/// </summary>
/// <param name="logger">Логгер для записи информации о работе производителя сообщений.</param>
...
public sealed class RabbitMqProducer(Serilog.ILogger logger, RabbitMqConnectionSource connectionSource)
{
	...
	/// <summary>
	/// Публикует сообщение напрямую в указанный обменник с заданным маршрутизирующим ключом.
	/// </summary>
	/// <typeparam name="T">Тип сообщения.</typeparam>
	/// <param name="message">Сообщение для публикации.</param>
	/// <param name="exchange">Имя обменника, в который публикуется сообщение.</param>
	/// <param name="routingKey">Маршрутизирующий ключ для сообщения.</param>
	/// <param name="options">Опции публикации сообщения.</param>
