...
/// <summary>
/// Обработчик команды изменения email пользователя в режиме разработки.
/// </summary>
...
{
	/// <summary>
	/// Выполняет изменение email пользователя по команде.
	/// </summary>
	/// <param name="command">Команда изменения email пользователя.</param>
