...
/// <summary>
/// Обработчик команды для выхода пользователя из системы.
/// </summary>
...
{
	/// <summary>
	/// Выполняет выход пользователя из системы по команде.
	/// </summary>
	/// <param name="command">Команда выхода пользователя из системы.</param>
