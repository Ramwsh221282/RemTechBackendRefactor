...
/// <summary>
/// Фоновая служба для очистки истекших токенов доступа.
/// </summary>
/// <param name="logger">Логгер для записи информации о работе службы.</param>
...
public sealed class ExpiredTokensCleanerService(Serilog.ILogger logger, IServiceProvider services) : BackgroundService
{
	...
	/// <summary>
	/// Выполняет фоновую задачу очистки истекших токенов доступа.
	/// </summary>
