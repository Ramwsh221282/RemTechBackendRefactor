...
public sealed class ChangeMailerCredentialsTests(IntegrationalTestsFactory factory) : IClassFixture<IntegrationalTestsFactory>
{
    ...
    private async Task Change_Mailer_Credentials_Success()
    {
        ...
        string newSmtpPassword = "newSmtpPassword@123";
        string otherEmail = "newEmail@gmail.com";
        Result<Unit> result2 = await Services.ChangeMailerCredentials(mailer.Value.Id.Value, otherEmail, newSmtpPassword);
    ...
    {
        string email1 = "testEmail@gmail.com";
        string password1 = "testPassword";
        Result<Unit> result1 = await Services.AddMailer(email1, password1);
        Assert.True(result1.IsSuccess);
        
        string email2 = "newEmail@gmail.com";
        string password2 = "newSmtpPassword@123";
        ...
        string newSmtpPassword = "newlyNewSmtpPassword@123";
