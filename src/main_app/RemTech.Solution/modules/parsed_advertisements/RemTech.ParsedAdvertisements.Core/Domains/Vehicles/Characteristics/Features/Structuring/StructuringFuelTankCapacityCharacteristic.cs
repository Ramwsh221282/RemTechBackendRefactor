...
public sealed class StructuringFuelTankCapacityCharacteristic : IStructuringCharacteristic
{
    private readonly NotEmptyString _name;
    private readonly NotEmptyString _value;

    public StructuringFuelTankCapacityCharacteristic(NotEmptyString name, NotEmptyString value)
    {
        _name = name;
        _value = value;
    }
    ...
    {
        ctx = null;
        if (_name != "Объём топливного бака") return false;
