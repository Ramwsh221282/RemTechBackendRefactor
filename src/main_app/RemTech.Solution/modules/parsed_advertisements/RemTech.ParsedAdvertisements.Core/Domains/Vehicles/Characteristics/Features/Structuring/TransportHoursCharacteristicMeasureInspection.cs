...
public sealed class TransportHoursCharacteristicMeasureInspection(NotEmptyString name, NotEmptyString value)
    : ICharacteristicMeasureInspection
{
    public Characteristic Inspect(Characteristic ctx)
    {
        return name != "Моточасы"
            ...
            : new Characteristic(
                new Characteristic(ctx, new CharacteristicMeasure("моточасы")),
