using RemTech.ParsedAdvertisements.Core.Features.SinkVehicles.Decorators.Logging;
using RemTech.ParsedAdvertisements.Core.Features.SinkVehicles.Decorators.Postgres;
using RemTech.ParsedAdvertisements.Core.Features.SinkVehicles.Decorators.RabbitMq;
using RemTech.Postgres.Adapter.Library;
using RemTech.RabbitMq.Adapter;
using Serilog;

namespace RemTech.ParsedAdvertisements.Core.Features.SinkVehicles.Decorators.BackgroundService;
