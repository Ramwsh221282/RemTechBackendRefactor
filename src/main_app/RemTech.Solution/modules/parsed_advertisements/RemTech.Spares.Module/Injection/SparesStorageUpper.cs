...
public sealed class SparesStorageUpper : IStorageUpper
{
    private readonly IOptions<DatabaseOptions> _options;

    public SparesStorageUpper(IOptions<DatabaseOptions> options)
    {
        _options = options;
    }
    ...
    public Task UpStorage()
    {
        ...
        Assembly assembly = typeof(SparesStorageUpper).Assembly;
