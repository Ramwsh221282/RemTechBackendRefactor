...
public sealed record ParsingStatistics
{
    ...
    public Result<ParsingStatistics> IncreaseParsedCount(int amount)
    {
        ...
        return updated.IsFailure ? (Result<ParsingStatistics>)updated.Error : (Result<ParsingStatistics>)(this with { ParsedCount = updated.Value });
    }
    ...
    public Result<ParsingStatistics> AddWorkTime(long totalElapsedSeconds)
    {
        ...
        return updated.IsFailure ? (Result<ParsingStatistics>)updated.Error : (Result<ParsingStatistics>)(this with { WorkTime = updated.Value });
    }
