...
public sealed class SetParserLinkWorkTimeTests(IntegrationalTestsFixture fixture) : IClassFixture<IntegrationalTestsFixture>
{
    ...
    private async Task Set_Link_Work_Time_Success()
    {
        ...
        long workTimeSeconds = 3600;
        Result<SubscribedParserLink> setWorkTimeResult = await Services.SetLinkWorkTime(parserId, linkId, workTimeSeconds);
    ...
    private async Task Set_Link_Work_Time_With_Large_Value_Success()
    {
        ...
        long largeWorkTime = 86400;
        Result<SubscribedParserLink> setWorkTimeResult = await Services.SetLinkWorkTime(parserId, linkId, largeWorkTime);
