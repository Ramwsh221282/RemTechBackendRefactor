...
public sealed class GetSparesQuery : IQuery
{
    ...
    {
        if (RegionId.HasValue) return this;
    ...
    {
        if (!string.IsNullOrWhiteSpace(Oem)) return this;
        if (string.IsNullOrWhiteSpace(oem)) return this;
        Oem = oem;
        return this;
    }
    ...
    {
        if (PriceMin.HasValue) return this;
        if (price is null) return this;
        PriceMin = price;
        return this;
    }
    ...
    {
        if (PriceMax.HasValue) return this;
        if (price is null) return this;
        PriceMax = price;
        return this;
    }
    ...
    {
        if (string.IsNullOrWhiteSpace(mode)) return this;
        OrderMode = mode;
        return this;
    }
    ...
    {
        if (size is null) return this;
        if (size.Value > 50) return this;
        PageSize = size.Value;
        return this;
    }
}