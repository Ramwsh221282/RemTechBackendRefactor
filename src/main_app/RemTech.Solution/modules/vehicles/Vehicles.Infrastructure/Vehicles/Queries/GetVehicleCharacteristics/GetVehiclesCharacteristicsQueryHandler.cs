...
{
    public async Task<GetVehicleCharacteristicsQueryResponse> Handle(GetVehicleCharacteristicsQuery query, CancellationToken ct = new CancellationToken())
    {
    ...
    private static async Task<GetVehicleCharacteristicsQueryResponse> FormResponseUsingReader(DbDataReader reader, CancellationToken ct)
    {
        GetVehicleCharacteristicsQueryResponse response = new();
        while (await reader.ReadAsync(ct))
        {
            response.Characteristics.Add(new VehicleCharacteristicsResponse()
            {
