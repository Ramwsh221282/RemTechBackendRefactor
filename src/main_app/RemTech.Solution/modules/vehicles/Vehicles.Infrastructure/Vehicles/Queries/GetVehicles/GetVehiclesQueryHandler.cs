...
) : IQueryHandler<GetVehiclesQuery, GetVehiclesQueryResponse>
{
    ...
    public async Task<GetVehiclesQueryResponse> Handle(
    ...
    )
    {
        ...
        (parameters, string filterSql) = FormVehiclesQuery(
            query.Parameters,
            parameters,
            embeddings,
            searchOptions
        ...
        while (await reader.ReadAsync(ct))
        {
            ...
            response.Vehicles.Add(
                new VehicleResponse()
                {
                    ...
                    Photos = JsonSerializer.Deserialize<string[]>(
    ...
    {
        (parameters, string filterSql) = FormVehiclesFilterSql(
            queryParameters,
            parameters,
            embeddings,
            searchOptions
    ...
    )
    {
        ...
        parameters.Add(
            "@embedding_search_threshold",
            searchOptions.EmbeddingSearchThreshold,
            DbType.Double
        );
