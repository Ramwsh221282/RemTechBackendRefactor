...
/// <summary>
/// Тесты для добавления транспортного средства с использованием поиска по встраиванию.
/// </summary>
/// <param name="fixture">Фикстура для интеграционных тестов без контейнеров.</param>
public sealed class AddVehicleWithEmbeddingSearchTests(NoContainersIntegrationalTestsFixture fixture)
	: IClassFixture<NoContainersIntegrationalTestsFixture>
{
	...
	private async Task Add_Vehicles_Success()
	{
		...
		ICommandHandler<AddVehicleCommand, Unit> handler = scope.ServiceProvider.GetRequiredService<
			ICommandHandler<AddVehicleCommand, Unit>
		>();
