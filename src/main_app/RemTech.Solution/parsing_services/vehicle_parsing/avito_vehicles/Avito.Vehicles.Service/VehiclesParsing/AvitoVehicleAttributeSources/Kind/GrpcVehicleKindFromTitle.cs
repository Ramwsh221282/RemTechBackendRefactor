    ...
    : IParsedVehicleKindSource
{
    ...
    {
        string text = await new TextFromWebElement(
            await new PageElementSource(page).Read(_titleSelector)
        ).Read();
        ...
        return ctx
            ...
            : throw new ArgumentException(
                "Vehicle kind was not recognized through grpc recognizer service."
            );
    }
}
