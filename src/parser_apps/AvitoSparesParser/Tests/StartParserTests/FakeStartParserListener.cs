...
public sealed class FakeStartParserListener(
    ...
    Serilog.ILogger? logger) : BackgroundService
{
    ...
    private Serilog.ILogger? Logger { get; } = logger?.ForContext<FakeStartParserListener>();
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        Logger?.Information("Consuming started.");
    }
